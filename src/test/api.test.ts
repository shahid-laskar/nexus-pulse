...
describe('API Client Method Structures', () => {
  ...
  it('defines all required ebApi methods', () => {
    ...
    expect(typeof ebApi.uploadLogo).toBe('function')
    expect(typeof ebApi.uploadBanner).toBe('function')
    expect(typeof ebApi.uploadLegalDoc).toBe('function')
    expect(typeof ebApi.listChangeRequests).toBe('function')
    expect(typeof ebApi.getChangeRequest).toBe('function')
    expect(typeof ebApi.createChangeRequest).toBe('function')
    expect(typeof ebApi.resubmitChangeRequest).toBe('function')
  })
  ...
  it('defines all required nocApi methods', () => {
    ...
    expect(typeof nocApi.getInstance).toBe('function')
    ...
    expect(typeof nocApi.listChangeRequests).toBe('function')
    expect(typeof nocApi.approveChangeRequest).toBe('function')
